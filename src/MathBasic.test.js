...
describe('A subtract function', () => {
  ...
  it('should return a - b when given two number parameters', () => {
    expect(MathBasic.subtract(6, 2)).toEqual(4);
    expect(MathBasic.subtract(16, 8)).toEqual(8);
    expect(MathBasic.subtract(9, 7)).toEqual(2);
  });
});
...
describe('A multiply function', () => {
  ...
  it('should return a * b when given two number parameters', () => {
    expect(MathBasic.multiply(6, 2)).toEqual(12);
    expect(MathBasic.multiply(8, 8)).toEqual(64);
    expect(MathBasic.multiply(9, 7)).toEqual(63);
  });
});
...
describe('A divide function', () => {
  ...
  it('should return a * b when given two number parameters', () => {
    ...
    expect(MathBasic.divide(8, 8)).toEqual(1);
    expect(MathBasic.divide(49, 7)).toEqual(7);
  });
});
